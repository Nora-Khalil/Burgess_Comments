...
directory = f'/work/westgroup/nora/Code/projects/Burgess_Comments/2_BTP_optimization/models/edited_RMG/{file_name}'
...
#                 print(' initial guess has been set')
        ...
        df1.to_csv(f'{file_name}_x.csv', index=False)
