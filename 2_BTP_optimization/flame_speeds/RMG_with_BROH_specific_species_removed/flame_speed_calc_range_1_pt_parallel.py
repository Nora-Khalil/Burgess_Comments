...
BTPmole_list = [0.07230222222222221]#### for this run, this is not really volume fraction. This value is the moles of BTP (normalized to oxygen) volume fraction can be found on line 45 
...
with open(f'./data/speed_{file_name}', 'w+') as g:
    g.write(directory)
    g.write('\n')
